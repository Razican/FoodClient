...
public class Controller {
	...
	public static String register(final String name, final String lastName,
			final String email, final String username, final char[] password,
			final char[] pass_conf, final boolean gluten,
		...
		final JSONObject apiCall = Api.register(name, lastName, email,
				username, password, gluten, diabetes, vegetables, milk);
		if (apiCall.get("error").equals(JSONObject.NULL))
			return null;
